...
void setUp(void)
{
	...
	// these calls must exists to solely test the throttle channel wthout worrying about the others
	...
	PilotInstructions_SetZTimestamp(DUMMY_VALID_TIMESTAMP_0);
	PilotInstructions_SetZTimestamp(DUMMY_VALID_TIMESTAMP_1);
}
...
void test_PilotInstructions_HandlesMaxDutyCycleInput(void)
{
	...
	TEST_ASSERT_FLOAT_WITHIN(ACCEPTABLE_ERROR, 100, ReturnedPilotResult.throttlePercentage);
}
...
void test_PilotInstructions_HandlesMinDutyCycleInput(void)
{
	...
	TEST_ASSERT_EQUAL(AAQUAD_SUCCEEDED, r);
	TEST_ASSERT_FLOAT_WITHIN(ACCEPTABLE_ERROR, 0, ReturnedPilotResult.throttlePercentage);
}
...
void test_PilotInstructions_HandlesIntermediateDutyCycleInput(void)
{
	...
	TEST_ASSERT_EQUAL(AAQUAD_SUCCEEDED, r);
	TEST_ASSERT_FLOAT_WITHIN(ACCEPTABLE_ERROR, 50, ReturnedPilotResult.throttlePercentage);
}
